            ...
            children: [
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  padding: EdgeInsets.symmetric(horizontal: 32.0, vertical: 16.0), // Larger padding
                  backgroundColor: Color.fromARGB(255, 43, 34, 28), // Button color
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      'Continue',
                      style: TextStyle(fontSize: 18.0, color: Colors.white), // Larger font size and white color
                    ),
                    SizedBox(width: 8.0), // Space between text and arrow
                    Icon(Icons.arrow_forward, color: Colors.white), // White arrow
                  ],
                ),
              ),
            ],
